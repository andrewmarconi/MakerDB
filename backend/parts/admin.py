...
from .models import Part, Designator
...
class PartAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("General", {"fields": ("name", "part_type", "designator", "description", "notes")}),
        ("Manufacturing", {"fields": ("mpn", "manufacturer", "footprint")}),
        (
            "Inventory Control",
            {"fields": ("low_stock_threshold", "default_storage", "is_default_storage_mandatory", "attrition_percent")},
        ),
        ("Relations", {"fields": ("project", "meta_parts", "substitutes")}),
        ("Metadata", {"fields": ("tags", "cad_keys", "custom_fields")}),
    )


@admin.register(Designator)
